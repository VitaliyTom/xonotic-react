		...
		return (
			<React.Fragment>
				<div className="spectator">
					<h3>
						<span className="spectators_text">SPECTATORS</span> (<span className="number_spectators">
				...
				<div className="played">
					<h3>
						<span className="played_text">PLAYED</span> (<span className="number_played">
					...
					{this.state.serverName === 'exe.pub | Relaxed Running | CTS/XDF' ? (
						...
						<div className="team">
							<div className="red_team">
								<h4>
									<span className="red_team_text">RED TEAM</span> (<span className="number_red_team_text">
							...
							<div className="blue_team">
								<h4>
									<span className="blue_team_text">BLUE TEAM</span> (<span className="number_blue_team_text">
